...
import { RouterResolve, getRoleResolve, getTestByIdRouterResolve, getPremiumTestResolve, getExamTimeStatusResolve } from './create-test-page/service/router.resolve';
...
import{ ExamStartHomeComponent } from './exam-start-home/exam-start-home.component';
...
const routes: Routes = [
  ...
  {
    path:'candidate-report/:examId/:candidateId' , 
    component: CandidateExamReportComponent,
  },
  /////////
  ...
  { 
    path: 'exam-start-candidate', 
    component:ExamStartHomeComponent,
    resolve: { httpData: getExamTimeStatusResolve },
  }
];
