...
export class TestCardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.testDetailForm = this.fb.group({
      datetimepicker: new FormControl('', [Validators.required]),
      testDurationHours: new FormControl('', [Validators.required,Validators.min(0), Validators.max(59)]),
      testDurationMinutes: new FormControl('', [Validators.required,Validators.min(0), Validators.max(59)]),
      Easy: new FormControl('', [Validators.required ,Validators.min(0), Validators.max(this.testData.easy)]),
      Medium: new FormControl('', [Validators.required ,Validators.min(0), Validators.max(this.testData.medium)]),
      Hard: new FormControl('',[Validators.required ,Validators.min(0), Validators.max(this.testData.hard)])
    });
  ...
  onSubmit(event) {
    ...
    this.shareData.date = this.testDetailForm.value.datetimepicker;
    this.shareData.duration = this.testDetailForm.value.testDurationHours +":"+this.testDetailForm.value.testDurationMinutes+":00";
    if(this.isNegative){
    ...
    this.shareData.sectionA = this.testDetailForm.value.Easy;
    this.shareData.sectionB = this.testDetailForm.value.Medium;
    this.shareData.sectionC = this.testDetailForm.value.Hard;
